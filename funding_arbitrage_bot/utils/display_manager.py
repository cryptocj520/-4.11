...
class DisplayManager:
    ...
    def update_market_data(self, data: Dict[str, Dict]):
        ...
        table.add_column("方向一致", style="green", justify="center")
        table.add_column("开仓时间", style="cyan", justify="center")  # 新增开仓时间列
        ...
        try:
            ...
            for symbol, symbol_data in data.items():
                ...
                row_data = {
                    ...
                    "open_time": formatted_open_time  # 添加开仓时间
                }
            ...
            for row in sorted_rows:
                table.add_row(
                    ...
                    row["direction_consistent"],
                    row["open_time"]  # 添加开仓时间
                )
